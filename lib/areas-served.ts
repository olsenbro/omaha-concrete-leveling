...
export const cityAreas: CityArea[] = [
  ...
  },
  {
    ...
    intro: [
      "Council Bluffs sits directly across the Missouri River from Omaha — and contractors in our network serve both states. If you're an Iowa homeowner dealing with sunken driveways, uneven sidewalks, or settling patio slabs, you don't need to find a separate contractor. Local specialists regularly level concrete throughout Council Bluffs, Carter Lake, and the surrounding Pottawattamie County area.",
